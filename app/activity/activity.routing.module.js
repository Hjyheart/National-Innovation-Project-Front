...
var activityDetail_component_1 = require("./activityDetail/activityDetail.component");
var routes = [
    {
        path: 'activities',
        component: activityList_component_1.ActivityListComponent
    },
    {
        path: 'activity/:id',
        component: activityDetail_component_1.ActivityDetailComponent
    }
];
